...
async function resizeImageData(imageData, targetWidth, targetHeight) {
  // Create a Jimp image from the existing data
  ...
  // Resize the image using the correct syntax
...
async function runAnalysis() {
  ...
  try {
    ...
    console.log("Analyzing image000002.png:");
    const image2Data = await analyzeGreyTones('./image0000002.png');
